...
#if defined(NDEBUG)
# error "Iolanicoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Iolanicoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s IOC additional fees, %d delta bytes\n",
