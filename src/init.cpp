...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/iolanicoin-project/iolanicoin>";
    const std::string URL_WEBSITE = "<https://iolanicoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Iolanicoin version %s\n", FormatFullVersion());
}
