...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s iolanicoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  iolanicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded iolanicoin transaction") + "\n" +
              "  iolanicoin-tx [options] -create [commands]   " + _("Create hex-encoded iolanicoin transaction") + "\n" +
              "\n";
